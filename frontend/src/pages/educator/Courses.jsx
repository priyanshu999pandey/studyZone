...
const Courses = () => {
  ...
  return (
    <div className="min-h-screen bg-primary dark:bg-surface px-4 pt-6 pb-16">
      ...
      {/* 🔙 Back Button (same style as Dashboard) */}
      ...
      <div className="max-w-6xl mx-auto bg-secondary dark:bg-surface-muted rounded-2xl shadow-xl p-6 md:p-8">
        ...
        <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4 mb-8">
          ...
          <button
            ...
            className="flex items-center justify-center gap-2 px-6 py-2 rounded-xl bg-primary text-black dark:bg-surface dark:text-white font-medium hover:scale-105 transition"
          >
            <FaPlus />
            Create Course
          </button>
        ...
        <div className="space-y-4 md:hidden">
          {courses.map((course) => (
            <div
              key={course._id}
              className="bg-primary text-black dark:bg-surface dark:text-white rounded-xl p-4 space-y-3"
            >
        ...
        <div className="hidden md:block overflow-x-auto">
          <table className="w-full border-collapse">
            <thead>
              <tr className="border-b border-gray-600 text-left text-sm text-gray-700 dark:text-gray-300">
